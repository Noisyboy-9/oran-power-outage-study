...
The rest of this section is organized as follows: Subsection~\ref{subsec:simulation-architecture} describes the simulator architecture and execution procedure. Subsection~\ref{subsec:experimental-configuration} presents the experimental configuration and policy comparison. Subsection~\ref{subsec:metrics-analysis} defines the metrics, analysis procedure, and implementation-verification checks.
