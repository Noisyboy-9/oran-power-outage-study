...
\begin{tabular}{@{}r@{\quad}p{0.82\linewidth}@{}}
1 & Update each RU battery according to its previous status and served-user load. \\
2 & Apply the selected policy to determine the active and sleep states of feasible RUs. \\
3 & Regenerate link-quality weights for all in-range RU--user pairs. \\
4 & Recompute user--RU associations using the eligible active RUs and link-quality weights. \\
\end{tabular}
\end{algorithm}
